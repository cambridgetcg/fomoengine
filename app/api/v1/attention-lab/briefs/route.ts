import { createBriefArtifact } from "@/lib/attention/artifact";
import { attentionBriefInputSchema } from "@/lib/attention/contract";
...
const route = createAttentionRoute("POST", (input) => createBriefArtifact(input, attentionCatalogueDigest()), attentionBriefInputSchema);
